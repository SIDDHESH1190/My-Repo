			...
			<h4><i class="fas fa-list"></i> DASHBOARD</h4>
				<h4>Hello <%=session.getAttribute("name")%></h4>
			  	...
			  	<div class="DashboardContent">
			    	...
			    	<ul>
			      		<li>
			        	<a href="UserProfile.jsp"><i class="fas fa-home"></i> Home</a>
			      		</li>
			      		
			      		<li>
			       		<a href="AllProduct.jsp"><i class="fas fa-sign-in-alt"></i>All Products</a>
			      		</li>
			      		
			      		<li>
			       		<a href="MyCart.jsp"><i class="fas fa-sign-in-alt"></i>My Cart</a>
			      		</li>
			        	...
			        	<a href="ContactUs.jsp"><i class="far fa-id-card"></i> Contact Us</a>
			      		...
			      		<li>
			        	<a href="HomePage.jsp" ><i class="fas fa-sign-in-alt"></i> Logout</a>
			      		</li>
			    	</ul>
			    </div>
		...
		<div class="CategorySection">
			<table border="1px">
				<tr style="border-radius :15px;">
					<td><a href="FruitsSection.jsp"> <img src="fruits.jpg" alt="Friuts"><a></td>
