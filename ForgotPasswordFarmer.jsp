...
<body>
<div class="Box">
	<form action="ForgotPasswordFarmer.jsp">
		<table>
...
<%
	if(request.getParameter("emailid")!=null && request.getParameter("answer")==null)
	{
		...
		NewFarmerRegistrationModel u=SearchFarmerDAO.SearchFarmer(e);
%>
		<div align="left">
	...
	{
			String e=request.getParameter("emailid");
			int status=SearchFarmerDAO.CheckAnswer(request.getParameter("answer"),e);
			
			if(true)
			{			
			%>
				<div>
					<form action="UpdateFarmerPasswordServlet" method="post">
						<input type="hidden" name="emailid" value=<%=e%>><br>
